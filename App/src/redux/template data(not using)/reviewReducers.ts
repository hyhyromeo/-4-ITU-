  ...
  review: [
    {
      ...
      name: "John Smith",
      rate: "5",
      text: "Amazing job. Well done, fast and clean. Is the best handyman and gentle dude to really help me solve my problem.",
    },
    {
      id: 2,
      avatar:
  ...
  appointments: [
    {
      ...
      date: "26/02/2019",
      amount: "1005",
      text: "Keep close to Natures heart... and break clear away,once in awhile, and climb a mountain or spend...",
    },
    {
      avatar:
        "https://images.unsplash.com/photo-1534349762230-e0cadf78f5da?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80",
